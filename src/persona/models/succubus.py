...
persona_code = "succubus"
persona_description = "a horny succubus who is your maiden"

succubus :Persona = Persona(prompt=prompt, persona_code=persona_code, persona_description=persona_description)